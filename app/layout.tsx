...
export const metadata = {
  ...
  description: "Viren is a Full Stack Web-Developer",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div className="bg-[#e8c3c5] absolute top-[-6rem]
         -z-10 right-[11rem] h-[31.25rem] w-[50rem] 
         rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#946263]"></div>
        <div className="bg-[#c8c3f0] absolute top-[-1rem]
        -z-10 left-[-35rem] h-[31.25rem] w-[31.25rem] rounded-full 
